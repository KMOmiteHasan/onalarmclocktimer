!(function (a, i) {
  ...
  function o(a) {
    var i = 0,
      ...
      A = 0,
      n = 1;
    for (45 === a.charCodeAt(0) && (n = -(i = 1)); i < e.length; i++)
      A = 60 * A + m(e.charCodeAt(i));
  ...
  function f(a, i) {
    var r,
      e = [];
    for (r = 0; r < i.length; r++) e[r] = a[i[r]];
    return e;
  }
  function p(a) {
    var i = a.split("|"),
    ...
    return (
      ...
      (function (a, i) {
        for (var r = 0; r < i; r++)
          a[r] = Math.round((a[r - 1] || 0) + 6e4 * a[r]);
        a[i - 1] = 1 / 0;
      })(o, e.length),
      {
        name: i[0],
  ...
  function E(a, i) {
    for (var r, e; (e = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
      (r = new h(new Date(a.at + e))).offset === a.offset ? (a = r) : (i = r);
    return a;
  }
  function g(a, i) {
  ...
  function T(a, i) {
    var r, e;
    for (l(i), r = 0; r < i.length; r++)
      (e = i[r]), (u[e] = u[e] || {}), (u[e][a] = !0);
  }
  function S() {
    try {
    ...
    var r,
      ...
      c = (function () {
        var a,
          ...
          c = [o];
        for (r = 1; r < 48; r++)
          (i = new h(new Date(e, r, 1))).offset !== o.offset &&
            ((a = E(o, i)), c.push(a), c.push(new h(new Date(a.at + 6e4)))),
            (o = i);
        for (r = 0; r < 4; r++)
          c.push(new h(new Date(e + r, 0, 1))),
            c.push(new h(new Date(e + r, 6, 1)));
        return c;
      })(),
      A = c.length,
      n = (function (a) {
        var i,
          ...
          A = [];
        for (i = 0; i < o; i++)
          for (r in (e = u[a[i].offset] || {}))
            e.hasOwnProperty(r) && (c[r] = !0);
        for (i in c) c.hasOwnProperty(i) && A.push(s[i]);
        return A;
      })(c),
      t = [];
    for (e = 0; e < n.length; e++) {
      for (r = new d(z(n[e]), A), o = 0; o < A; o++) r.scoreOffsetAt(c[o]);
      t.push(r);
    }
  ...
  function z(a, i) {
    ...
    return e instanceof M
      ...
      ? ((e = new M(e)), (A[a] = e))
      : n[a] && i !== z && (r = z(n[a], z))
      ? ((e = A[a] = new M())._set(r), (e.name = s[a]), e)
      : null;
  }
  function _(a) {
    var i, r, e, o;
      ...
      (function (a) {
        ...
        if (a && a.length)
          for (i = 0; i < a.length; i++)
            (r = (o = a[i].split("|"))[0].toUpperCase()),
              (e = o[1].split(" ")),
              (t[r] = new b(r, e));
      })(a.countries),
      (D.dataVersion = a.version);
  }
  function B(a) {
    var i = "X" === a._f || "x" === a._f;
  ...
  function D(a) {
    ...
    return (
      e && !c.isMoment(a) && B(o) && o.add(e.parse(o), "minutes"), o.tz(r), o
    );
  }
  (r < 2 || (2 == r && e < 6)) &&
    y(
    ...
    (M.prototype = {
      ...
      _index: function (a) {
        var i,
          r = +a,
          e = this.untils;
        for (i = 0; i < e.length; i++) if (r < e[i]) return i;
      },
      countries: function () {
        var i = this.name;
      ...
      parse: function (a) {
        ...
        for (o = 0; o < t; o++)
          if (
            ...
            (r = A[o + 1]),
            (e = A[o ? o - 1 : o]),
            i < r && D.moveAmbiguousForward
              ? (i = r)
              : e < i && D.moveInvalidForward && (i = e),
            c < n[o] - 6e4 * i)
          )
            return A[o];
        return A[t];
    ...
    (D.zonesForCountry = function (a, i) {
      if (
        !(a = (function (a) {
      ...
      return i
        ? r.map(function (a) {
            return { name: a, offset: z(a).utcOffset(new Date()) };
          })
        : r;
    });
  var L,
  ...
  (c.tz = D),
      ...
      if (
        (void 0 === a._z &&
          (e &&
            B(a) &&
            !a._isUTC &&
            ((a._d = c.utc(a._a)._d), a.utc().add(e.parse(a), "minutes")),
          (a._z = e)),
        a._z)
      )
        if (
    ...
    (N.zoneName = O(N.zoneName)),
    (N.zoneAbbr = O(N.zoneAbbr)),
    (N.utc = v(N.utc)),
    (N.local = v(N.local)),
    (N.utcOffset =
      ((L = N.utcOffset),
